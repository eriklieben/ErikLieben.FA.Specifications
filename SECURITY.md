...
1. **GitHub Private Vulnerability Reporting** (preferred): Use the [Security Advisories](https://github.com/eriklieben/ErikLieben.FA.Specifications/security/advisories/new) feature to report privately.
